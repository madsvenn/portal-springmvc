...
<script id="query-form" type="text/html">
    <form class="layui-form" id="form">
        <input type="hidden" name="targetUserId" value="${userInfo.id}">
        <div class="layui-inline">
            <label class="layui-form-label" style="width: auto">⼯单状态</label>
            <div class="layui-input-inline">
                <select name="orderStatusId" class="layui-select">
...
<script type="text/html" id="tool">
    ...
    {{# }else{ }}
    <shiro:hasPermission name="permission:update">
        <a href="order/todo/preview/page?id={{d.id}}" class="layui-btn layui-btn-normal layui-btn-xs" >详情</a>
    </shiro:hasPermission>
    {{# } }}
</script>
