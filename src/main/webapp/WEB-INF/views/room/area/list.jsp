    ...
    <form class="layui-form" id="form">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input class="layui-input" name="areaName" value="{{d.where.areaName}}" type="text" placeholder="请输⼊区域名称"/>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <a href="room_area/add/page" class="layui-btn ">新增</a>
            </shiro:hasPermission>
        </div>
    </form>
</script>
...
<script type="text/html" id="tool">
    ...
    <a href="room_area/edit/page?id={{d.id}}" class="layui-btn layui-btn-warm layui-btn-xs" >修改</a>
                    </shiro:hasPermission>
        ...
        table.on('tool(table)',function (obj) {
            if (obj.event==='delete') {
                ...
                layer.confirm('是否删除喵~',{
                    ...
                    console.log('confirm');
                    //根据index来关闭
                    location.href = 'room_area/delete?id='+id;
                    layer.close(index);
                    }
                )
            }
...
<span class="layui-breadcrumb">
 <a href="room_area/list">区域维护</a>
 <a href="room_area/list">区域列表</a>
 </span>
