        ...
        <div class="layui-input-block">
            ...
            >
                ...
                <c:forEach items="${equipmentBrandList}" var="item">
                    <c:choose>
                    <c:when test="${forData.brandId==item.id}">
