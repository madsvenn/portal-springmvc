...
<form class="layui-form" lay-filter="form" action="room-warn/edit"
      method="post">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">最⼤温度（C）</label>
        <div class="layui-input-block">
            <input class="layui-input"
                   required
                   name="maxTemperature"
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">最⼤存储（%）</label>
        <div class="layui-input-block">
            <input class="layui-input"
                   required
                   name="maxDisk"
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">最⼤访问</label>
        <div class="layui-input-block">
            <input class="layui-input"
                   required
                   name="maxRequest"
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">cpu占⽤（%）</label>
        <div class="layui-input-block">
            <input class="layui-input"
                   required
                   name="maxCpuUse"
