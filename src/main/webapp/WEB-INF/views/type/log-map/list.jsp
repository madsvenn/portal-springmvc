...
<%--${page}--%>
    ...
    <script type="text/html" id="btns">
        <shiro:hasPermission name="permission:update">
            <a lay-event="edit" href="log-map/edit/page?id={{d.id}}" class="layui-btn layui-btn-warm layui-btn-xs">修改</a>
        </shiro:hasPermission>
        ...
        <form class="layui-form " id="queryForm" lay-filter="queryFrom">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="url" class="layui-input " value="{{d.where.url==undefined?'':d.where.url}}"  placeholder="请输入接口地址">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <shiro:hasPermission name="permission:insert">
                    <a href="log-map/add/page" class="layui-btn layui-btn-sm" lay-event="add">添加</a>
                </shiro:hasPermission>
        ...
        layui.use('table', function(){
            ...
            let t = table.render({
                ...
                cols: [[ //表头
                    ...
                    {field: 'url', title: '接口地址', sort: true},
                    {field: 'action', title: '行为名称'},
            ...
            table.on('tool(test)',function(obj){
                ...
                if(obj.event == 'del'){
                    layer.confirm('正在删除',{
                        ...
                        console.log('confirm')
                        location.href = '<%=basePath%>log-map/delete?id='+id
                        layer.close(index)
                    })
                }
            })
