    ...
    <form class="layui-form" id="form">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input class="layui-input" name="brandName" value="{{d.where.brandName}}" type="text" placeholder="请输⼊品牌名称"/>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <shiro:hasPermission name="permission:insert">
                <a href="eqBrand/add/page" class="layui-btn ">新增</a>
            </shiro:hasPermission>
        </div>
    </form>
</script>
...
<script type="text/html" id="tool">
    <shiro:hasPermission name="permission:update">
        <a href="eqBrand/edit/page?id={{d.id}}" class="layui-btn layui-btn-warm layui-btn-xs" >修改</a>
    </shiro:hasPermission>
        ...
        table.on('tool(table)',function (obj) {
            if (obj.event==='delete') {
                ...
                layer.confirm('是否删除喵~',{
                        ...
                        console.log('confirm');
                        //根据index来关闭
                        location.href = 'eqBrand/delete?id='+id;
                        layer.close(index);
                    }
                )
            }
...
<span class="layui-breadcrumb">
 <a href="eqBrand/list">品牌维护</a>
 <a href="eqBrand/list">品牌列表</a>
 </span>
