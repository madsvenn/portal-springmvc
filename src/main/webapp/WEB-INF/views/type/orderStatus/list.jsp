    ...
    <form class="layui-form" id="form">
        ...
        <div class="layui-inline">
            ...
            <shiro:hasPermission name="permission:insert">
                <a href="orderStatus/add/page" class="layui-btn ">新增</a>
            </shiro:hasPermission>
        </div>
    </form>
</script>
...
<script type="text/html" id="tool">
    <shiro:hasPermission name="permission:update">
        <a href="orderStatus/edit/page?id={{d.id}}" class="layui-btn layui-btn-warm layui-btn-xs" >修改</a>
    </shiro:hasPermission>
    ...
    layui.use('table',function(){
        ...
        table.init('table',{
            ...
            cols:[[
                ...
                {field:'statusName',title:'状态名称'},
                {title:'操作',templet: '#tool'}
            ]],

            page:true,

            url:'orderStatus/list/page',
        ...
        table.on('tool(table)',function (obj) {
            if (obj.event==='delete') {
                ...
                layer.confirm('是否删除喵~',{
                        ...
                        console.log('confirm');
                        //根据index来关闭
                        location.href = 'orderStatus/delete?id='+id;
                        layer.close(index);
                    }
                )
            }
